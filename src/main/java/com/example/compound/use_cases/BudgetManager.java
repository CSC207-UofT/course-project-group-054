...
//        List<Budget> budgets = repositoryGateway.getBudgets();
    ...
    public List<String> getItems(String BUID) {
        return new ArrayList<>(this.budgetRepositoryGateway.findByUID(BUID).toBudget().getItems().keySet());
...
//        String IUID = Integer.toString(this.repositoryGateway.getNewIUID());
        ...
        String IUID = this.itemRepositoryGateway.save(new ItemTransferData(newItem)); // TODO: Is a separate item repository needed?
