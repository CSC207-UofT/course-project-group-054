...
public class BudgetManager {
    ...
    private final RepositoryGatewayI<Item> itemRepositoryGateway;
//    private final RepositoryGateway repositoryGateway;

    public BudgetManager(RepositoryGatewayI<Budget> budgetRepositoryGateway,
...
//        this.repositoryGateway = repositoryGateway;
    ...
    public boolean create(String GUID, String name, double maxSpend) {
        Group group = this.groupRepositoryGateway.findByUID(GUID); // TODO: instead of GUID, maybe group name? using findAll() and then loop over to get that group
...
//        List<Budget> budgets = repositoryGateway.getBudgets();
    ...
    public List<String> getItems(String BUID) {
        return new ArrayList<>(this.budgetRepositoryGateway.findByUID(BUID).getItems().keySet());
...
//        List<Item> items = this.repositoryGateway.getItems();
    ...
    public List<Expense> toExpenses(String BUID, ExpenseManager expenseManager) {
        Budget budget = this.budgetRepositoryGateway.findByUID(BUID);
...
//        Budget budget = this.repositoryGateway.findByBUID(BUID);
    ...
    public boolean remove(String GUID, String BUID) { // TODO: Instead of passing in the GUID, maybe pass in the name instead?
        Group group = this.groupRepositoryGateway.findByUID(GUID); // TODO: What if GUID is invalid?
//        Group group = this.repositoryGateway.findByGUID(GUID);
